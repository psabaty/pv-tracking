...
const populateDataButtonElement = document.getElementById('populate-data-button');
...
const setupUI = (user) => {
  if (user) {
    ...
    function createNewReading(){
      ...
      dbRef.child(timestamp).set({
        humidity: 70 + (Math.random()*20),
        pressure: 990 + (Math.random()*20),
    ...
    populateDataButtonElement.addEventListener('click', (e) => {
      createNewReading();
    });
